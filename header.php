		...
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item ">
						<a class="sidebar-link" href="Manage_category.php">
							<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Manage category</span>
						</a>
					</li>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="Manage_Product.php">
							<i class="align-middle" data-feather="settings"></i> <span class="align-middle">Manage Product</span>
						</a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="Create_New_Bill.php">
							<i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">Create New Bill</span>
						</a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="report.php">
							<i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">Report</span>
						</a>
					</li>
